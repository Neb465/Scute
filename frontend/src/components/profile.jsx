...
const Profile = () => {
	const { toggle, setToggle } = useButton();
			...
			{toggle && (
				<div className="bg-gray-50 w-40 h-35 md:w-50 md:h-45 lg:w-60 lg:h-55 my-2 rounded-lg flex flex-col">
					...
					<div className="flex flex-col w-full items-center gap-2 md:gap-3 lg:gap-4">
						...
						<button className="w-5/6 md:h-4/10 lg:h-1/2 rounded-xl py-1 md:py-2 lg:py-3 text-[12px] md:text-[13px] lg:text-[14px] font-medium bg-[#dedede] text-[#1a73e8] hover:bg-[#c9c9c9] transition-colors">
							Create Account
						</button>
					</div>
				</div>
